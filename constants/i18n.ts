...
const resources = {
  es: {
    translation: {
      ...
      deleteAccountConfirm2: 'Se perderán todos tus Eco-Puntos e insignias de forma permanente. ¿Confirmar eliminación?',
  ...
  en: {
    translation: {
      ...
      deleteAccountConfirm2: 'All your Eco-Points and badges will be permanently lost. Confirm deletion?',
